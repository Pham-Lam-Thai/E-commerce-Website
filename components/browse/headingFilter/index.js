...
export default function HeadingFilters({ priceHandler }) {
  ...
  return (
    <div className={styles.filters}>
        ...
        <div className={styles.filers_priceBtns}>
            <Tooltip
        ...
        <div
            className={styles.filters_shipping}
        ...
        <div
            className={styles.filters_rating}
        ...
        <div className={styles.filters_sort}>
            <span>Sort by</span>
            <div
                className={styles.filters_sort_list}
